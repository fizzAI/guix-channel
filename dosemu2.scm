    ...
    (source
     (origin
       ...
       (uri (git-reference
             ...
             (commit version)))
       (sha256
        (base32 "0j92frnhvrxr5wv4xdvh1ynjr8j05w7plmxv6z48z5fn5mv55rsc"))))
    (build-system meson-build-system)
    (native-inputs (list flex m4 bison))
      ...
      (source
       (origin
         ...
         (uri (git-reference
               ...
               (commit commit)))
         (sha256
          (base32 "0f9j9jsdkg0k1gvps77l6ccyf2vnlgw88lnkhm2fhwfd24ga8vhq"))))
      ...
      (arguments
       `(#:make-flags (list (string-append "prefix="
         ...
         #:phases (modify-phases %standard-phases
                    (delete 'check))))
      (native-inputs (list gcc-toolchain nasm))
      (inputs (list nasm))
      ...
      (source
       (origin
         ...
         (uri (git-reference
               ...
               (commit commit)))
         (sha256
          (base32 "06fxxjppkzl7p7skjz425754nkbhcicggc7h3fxn6xv00ak15w1j"))))
      (build-system gnu-build-system)
      (arguments
       `(#:make-flags (list (string-append "prefix="
                                           (assoc-ref %outputs "out"))
                            "CC=gcc" "STUBCC=smlrcc")
         #:phases (modify-phases %standard-phases
                    (delete 'configure)
                    (delete 'check))))
      (native-inputs (list gcc-toolchain smaller_c nasm))
      (synopsis
...
(define-public dj64dev
  (package
    ...
    (source
     (origin
       ...
       (uri (git-reference
             ...
             (commit version)))
       (sha256
        (base32 "0zg9iqmfvli4map8h4w9rfk84sclqy772lfjiym22iw96jnyjmah"))))
    (build-system gnu-build-system)
    (arguments
    ...
    (native-inputs (list thunk_gen
                         ...
                         libelf-shared
                         universal-ctags))
    (inputs (list thunk_gen djstub libelf-shared))
  ...
  (package
    ...
    (source
     (origin
       ...
       (sha256
        (base32 "09j7xhssc0bb5d6c9d1nm4s28p0hspx7izq48fj3bwyi7mvf2q0k"))))
    (build-system gnu-build-system)
    (arguments
